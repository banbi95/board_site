...
class ReplyTopicTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('board:reply_topic', kwargs={'pk': self.board.pk, 'topic_pk': self.topic.pk})
...
class ReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_view_function(self):
        view = resolve('/board/1/topic/1/reply/')
...
class SuccessfulReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_redirection(self):
        ...
        '''
        topic_posts_url = reverse('board:topic_posts', kwargs={'pk': self.board.pk, 'topic_pk': self.topic.pk})
